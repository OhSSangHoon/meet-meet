...
import { Gathering, GatheringsListProps } from "@/lib/types/gatherings";
import { useRouter } from "next/navigation";
import { fetchGatheringsPaginated } from "./shared/utils/fetch";
...
export default function GatheringsList({ 
    ...
    const isInitialLoading = fetchFromApi && !hasSSRData; // 찜목록은 로딩 표시 안함
